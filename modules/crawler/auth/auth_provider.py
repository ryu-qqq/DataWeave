...
from modules.crawler.auth.cookie_auth_provider import cookie_auth_provider
from modules.crawler.auth.default_auth_provider import default_auth_provider
...
class AuthProvider:
    ...
    def get_auth_provider(auth_type: str) -> AuthInterface:
        ...
        elif auth_type == AuthType.NONE.name:
