from modules.crawler.api_crawler import api_crawler
from modules.crawler.selenium_crawler import selenium_crawler
from modules.crawler.beautiful_soup_crawler import beautiful_crawler
