...
from dataweave.processor.batch_product_models_provider import BatchProductProvider
...
class BatchDataMapper:
    ...
    @staticmethod
    def extract_content(data_type: ProductDataType, file_path: str) -> List[BatchProductModel]:
        try:
            response_contents = []
