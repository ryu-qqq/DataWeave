...
class ProcessingTaskExecutor:
    ...
    @staticmethod
    async def perform_processing(crawl_type: str, headers: Dict[str, str],
                               site_context: SiteContextResponse,
                               auth_settings: CrawlAuthSettingResponse,
                               crawl_end_point: CrawlEndpointResponse,
        ...
        try:
            ...
            return action_provider.action(data=crawl_data, task_info=task_info, task= task_info)
