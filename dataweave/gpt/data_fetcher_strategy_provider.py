...
from dataweave.gpt.data_fetcher_strategy import DataFetcherStrategy, GitEventFetcherStrategy, \
    ProductDataFetcherStrategy
...
class GitEventFetcherStrategyProvider(DataFetcherStrategyProvider):
    ...
    def provide(self) -> DataFetcherStrategy:
        return GitEventFetcherStrategy(self.__product_hub_client)
...
class ProductDataFetcherStrategyProvider(DataFetcherStrategyProvider):
    ...
    def provide(self) -> DataFetcherStrategy:
        return ProductDataFetcherStrategy(self.__product_hub_client)
