...
class Batch:
    ...
    task_metadata: Optional[dict] = field(default_factory=dict)

    def to_dict(self) -> dict:
        result = asdict(self)
        result['data_type'] = self.data_type.name if isinstance(self.data_type, BatchDataType) else self.data_type
    ...
    def from_dict(data: Dict[str, Any]) -> 'Batch':
        return Batch(
            ...
            data_type=BatchDataType[data["data_type"]] if isinstance(data["data_type"], str) else data["data_type"],
